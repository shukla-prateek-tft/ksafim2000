//MCFR-1184
import PrintableReportCardUI from './PrintableReportCard.render';

const keys = ['code1', 'code2', 'code3', 'code4', 'code5', 'code6', 'code7', 'code8', 'code9', 'code10', 'code11', 'code12', 'code13'];
const hebrewLetters = [
  'א',
  'ב',
  'ג',
...
const PrintableReportCard = () => {
  return <PrintableReportCardUI data={data} />;
};
