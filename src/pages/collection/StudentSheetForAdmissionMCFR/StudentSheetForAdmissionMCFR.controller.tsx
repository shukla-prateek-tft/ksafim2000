//MCFR-1418
import StudentSheetForAdmissionMCFRUI from './StudentSheetForAdmissionMCFR.render';
...
const StudentSheetForAdmissionMCFR = () => {
  return <StudentSheetForAdmissionMCFRUI data={data} />;
};
