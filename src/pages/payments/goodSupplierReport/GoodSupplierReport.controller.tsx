//MCFR-1230
import GoodSupplierReportUI from './GoodSupplierReport.render';
...
const GoodSupplierReport = () => {
  return <GoodSupplierReportUI data={data} />;
};

export default GoodSupplierReport;
