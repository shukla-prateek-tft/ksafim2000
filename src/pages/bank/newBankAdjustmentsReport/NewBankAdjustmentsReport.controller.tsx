//MCFR1183
import NewBankAdjustmentsReportUI from './NewBankAdjustmentsReport.render';
...
const NewBankAdjustmentsReportColumn = () => {
  return <NewBankAdjustmentsReportUI data={data} />;
};

export default NewBankAdjustmentsReportColumn;
