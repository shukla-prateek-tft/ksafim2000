//MCFR1331
import ScholarshipsForStudentsUI from './ScholarshipsForStudents.render';

const keys = ['code1', 'code2', 'code3', 'code4', 'code5', 'code6', 'code7', 'code8'];
const hebrewLetters = [
  'א',
  'ב',
  'ג',
...
const ScholarshipsForStudents = () => {
  return <ScholarshipsForStudentsUI data={data} />;
};
