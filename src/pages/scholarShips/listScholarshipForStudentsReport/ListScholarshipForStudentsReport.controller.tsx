//MCFR1388
import ListScholarshipForStudentsReportUI from './ListScholarshipForStudentsReport.render';
...
const ListScholarshipForStudentsReport = () => {
  return <ListScholarshipForStudentsReportUI data={data} />;
};
