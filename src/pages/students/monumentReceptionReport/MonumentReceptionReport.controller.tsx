//MCFR-1337
import MonumentReceptionReportUI from './MonumentReceptionReport.render';
const keys = [
  'code1',
  'code2',
  'code3',
...
const MonumentReceptionReport = () => {
  return <MonumentReceptionReportUI data={data} />;
};

export default MonumentReceptionReport;
