...
import StatusByReceptionReportUI from './StatusByReceptionReport.render';
...
const StatusByReceptionReport = () => {
  return <StatusByReceptionReportUI data={data} customRowRenderer={customRowRenderer} />;
};
