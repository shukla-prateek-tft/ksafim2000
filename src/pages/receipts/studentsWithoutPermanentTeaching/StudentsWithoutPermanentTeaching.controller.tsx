//MCFR-0672
import StudentsWithoutPermanentTeachingUI from './StudentsWithoutPermanentTeaching.render';
...
const StudentsWithoutPermanentTeaching = () => {
  return <StudentsWithoutPermanentTeachingUI data={data} />;
};

export default StudentsWithoutPermanentTeaching;
