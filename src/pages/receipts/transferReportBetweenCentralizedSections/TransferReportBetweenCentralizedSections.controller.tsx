//MCFR-1382
import TransferReportBetweenCentralizedSectionsUI from './TransferReportBetweenCentralizedSections.render';
const keys = ['code1', 'code2', 'code3', 'code4'];
const hebrewLetters = [
  'א',
  'ב',
  'ג',
...
const TransferReportBetweenCentralizedSections = () => {
  return <TransferReportBetweenCentralizedSectionsUI data={data} />;
};
