//MCFR-1176
import CollectionStatusForClassBySubjectUI from './CollectionStatusForClassBySubject.render';

const keys = [
  'code1', 'code2', 'code3', 'code4', 'code5', 'code6', 'code7',
  'code8', 'code9', 'code10', 'code11', 'code12', 'code13', 'code14',
  'code15', 'code16', 'code17', 'code18', 'code19', 'code20', 'code21'
]
const hebrewLetters = [
  'א',
  'ב',
...
const CollectionStatusForClassBySubject = () => {
  return <CollectionStatusForClassBySubjectUI data={data} />;
};
