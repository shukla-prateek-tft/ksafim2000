//MCFR-0624
import RegularReceiptAReturnedCheckFromABankUI from './RegularReceiptAReturnedCheckFromABank.render';
const keys = ['code1', 'code2', 'code3', 'code4', 'code5', 'code6', 'code7'];
const hebrewLetters = [
  'א',
  'ב',
  'ג',
...
const RegularReceiptAReturnedCheckFromABank = () => {
  return <RegularReceiptAReturnedCheckFromABankUI data={data} />;
};
