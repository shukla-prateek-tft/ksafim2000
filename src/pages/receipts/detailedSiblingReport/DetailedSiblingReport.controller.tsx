// MCSR1415
import DetailedSiblingReportUI from './DetailedSiblingReport.render';
...
const DetailedSiblingReport = () => {
  return <DetailedSiblingReportUI data={data} />;
};

export default DetailedSiblingReport;
