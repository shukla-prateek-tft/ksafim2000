//MCFR1380
import ConsolidatedTransfersReportUI from './ConsolidatedTransfersReport.render';
...
const ConsolidatedTransfersReport = () => {
  return <ConsolidatedTransfersReportUI data={data} />;
};

export default ConsolidatedTransfersReport;
