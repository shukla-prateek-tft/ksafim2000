//MCFR-0637
import CollectionStatusForLayerReportUI from './CollectionStatusForLayerReport.render';
...
const CollectionStatusForLayerReport = () => {
  return <CollectionStatusForLayerReportUI data={data} />;
};
