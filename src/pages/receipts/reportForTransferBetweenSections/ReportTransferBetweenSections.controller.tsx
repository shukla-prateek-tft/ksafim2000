//MCFR-1376
import ReportTransferBetweenSectionsUI from './ReportTransferBetweenSections.render';
...
const ReportTransferBetweenSections = () => {
  return <ReportTransferBetweenSectionsUI data={data} />;
};
